  ...
  return (
    <article className="whoWeAre-info">
      <div className="whoWeAre-info-header">
        ...
        <h3 className="whoWeAre-info-header-subtitle">
          We provide highest level of care
        </h3>
        <p className="whoWeAre-info-header-paragraph">
          Nulla portitor accumsan tincidunt. Curabitur aliquet quam id dui
          posuere blandit vivamus magna justo lacinia eget consectetur convallis
          at tellus proin eget tortor.
        </p>
      </div>
      <div className="whoWeAre-info-figure">
        <div className="whoWeAre-info-image-container">
          <img
            className="whoWeAre-info-imagen-container__imagen"
            src={nurse}
            alt="nurse"
          />
        </div>
        <p className="whoWeAre-info-figure__caption">
          ...
          Vivamus magna justo acinia eget consectetur sed convallis at tellus.
        </p>
      </div>
