    ...
    <article className="whoWeAre-info">
      <div className="whoWeAre-info-header">
        ...
        <p className="whoWeAre-info-header-paragraph">
          Nulla portitor accumsan tincidunt. Curabitur aliquet quam id dui posuere blandit vivamus magna justo lacinia
          eget consectetur convallis at tellus proin eget tortor.
        </p>
      </div>
      <div className="whoWeAre-info-figure">
        ...
        <p className="whoWeAre-info-figure__caption">
          ...
          consectetur adipiscing elit. Vivamus magna justo acinia eget consectetur sed convallis at tellus.
        </p>
      </div>
      <div className="whoWeAre-info-button">
        <Button variant="solid" color="info">
          About Us <span className="arrow-button">{<BsArrowRight size={18} />}</span>
        </Button>
      </div>
    </article>
  );
