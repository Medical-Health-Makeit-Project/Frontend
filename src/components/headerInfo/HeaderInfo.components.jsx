import { BiPhone, BiUserVoice, BiPhoneCall, BiWorld } from 'react-icons/bi';
      ...
      <div className="main-info-container">
        <article className="info__emergencies-container">
          <div className="info__emergencies">
            <span className="info-icon-phone-emergency">
              <BiPhoneCall size={14} />
            </span>
          ...
          <div className="info__patients">
            <span className="info-icon-voice">
              <BiUserVoice size={14} />
            </span>
        ...
        <article className="info__options-container">
          <div className="info__phone">
            <span className="info-icon-phone">
              <BiPhone size={14} />
            </span>
          ...
          <div className="info__languages">
            <span className="info-icon-languages">
              <BiWorld size={14} />
            </span>
